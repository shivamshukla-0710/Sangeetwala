...
<li><a href="registration.aspx" style="color: #FF0000; font-weight: bold">Registration Here<i class="lh-10 tc-2 fz-18 fa fa-user"></i></a>
        ...
        <div class="other-page-header clearfix container-fluid epd-x">
            <h1 class="ff-ssp fz-40 fw-b text-center tc-6 lh-26 pd-y-b-60 text-uppercase">audio</h1>
            <h4 class="ff-ssp text-center tc-6 fz-14 lh-10 fw-b text-uppercase"><a href="Default2.aspx" class="tc-6">home</a><i class="fa fa-chevron-right pd-x-10 fz-10"></i><span class="tc-2 lh-10">audio</span></h4>
        </div>
        <div class="clr"></div>
        <!-- page heading end -->
...
<audio autoplay ="autoplay" controls="controls">
  ...
  <source src="audio.mp3" type="audio/mp3">
                        ...
                        <!-- END .entry-content -->
            <h2 class="fz-45 ff-ssp fw-n tc-3 text-center text-uppercase lh-28 pd-y-t-65 pd-y-b-60">t</h2>
