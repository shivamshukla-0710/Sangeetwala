...
<li><a href="registration.aspx" style="color: #FF0000; font-weight: bold">Registration Here<i class="lh-10 tc-2 fz-18 fa fa-user"></i></a>
        ...
        <div class="other-page-header clearfix container-fluid epd-x">
            <h1 class="ff-ssp fz-40 fw-b text-center tc-6 lh-26 pd-y-b-60 text-uppercase">video</h1>
            <h4 class="ff-ssp text-center tc-6 fz-14 lh-10 fw-b text-uppercase"><a href="Default2.aspx" class="tc-6">home</a><i class="fa fa-chevron-right pd-x-10 fz-10"></i><span class="tc-2 lh-10">video</span></h4>
        </div>
        <div class="clr"></div>
        <!-- page heading end -->

        <!-- error 404 page content start -->

        <section class="error-page container epd-x sp-lg">
            <h1 class="ff-ssp fw-b tc-2 text-center text-uppercase fz-75 pd-y-b-60 lh-50"></h1>
            <div class="error-page-img-holder">
                  <div >
                        <iframe width="450" height="300" src="https://www.youtube.com/embed/vmaLSliXTQI" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
</div>


            </div>

            <Div>https://www.youtube.com/channel/UCLnztEhnnEq5oQm6p2rKQbA</Div>
            <h2 class="fz-45 ff-ssp fw-n tc-3 text-center text-uppercase lh-28 pd-y-t-65 pd-y-b-60"></h2>
            <h4 class="ff-abee fw-n fz-20 lh-10 text-center pd-y-b-50">Please Keep Calm &amp; Return to the Homepage</h4>
            <a class="error-page-go-back-btn" href="#">back to home</a>
        </section>
        <div class="clr"></div>
