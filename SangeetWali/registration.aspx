...
<li><a href="registration.aspx" style="color: #FF0000; font-weight: bold">Registration Here<i class="lh-10 tc-2 fz-18 fa fa-user"></i></a>
  ...
  If you can't teach me to fly , <br/><br/> then teach me music  -- <br/> <br/><p style="color: #000066; font-size: small">Dr. Poonam Srivastava (Director of Sangeet kala sansthan chinhat lucknow)
        ...
        <div class="clr"></div>
         ...
         <br/>
           ...
           <tr><td>&nbsp;</td><td width="35%" 
                   style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';"></td><td width="45%"></td></tr>
                       <tr><td>&nbsp;</td><td width="35%" 
                               style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';">Date of Birth</td><td width="45%">
                                   <asp:TextBox ID="TextBox4" runat="server" BackColor="#0066FF" Width="250px" 
                                       Height="30px" ForeColor="White" AutoPostBack="True"></asp:TextBox>
                                   <asp:CalendarExtender ID="CalendarExtender2" TargetControlID="TextBox4" Format="dd/MM/yyyy" runat="server"></asp:CalendarExtender>
                               ...
                               <tr><td>&nbsp;</td><td width="35%" 
                                       style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';"></td><td width="45%"></td></tr>
            <tr><td>&nbsp;</td><td width="35%" 
                    style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';">Age</td><td width="45%">
                ...
                <asp:TextBox ID="TextBox8" runat="server" 
                    BackColor="#0066FF" Width="250px" Height="30px" ForeColor="White"></asp:TextBox></td></tr>
                                ...
                                <tr><td>&nbsp;</td><td width="35%" 
                                        style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';"></td><td width="45%"></td></tr>
            <tr><td>&nbsp;</td><td width="35%" 
                    style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';">Guru / Master Name</td><td width="45%">
            ...
            <td width="35%" 
                ...
                <asp:ListItem>Other</asp:ListItem>
                    ...
                    <tr><td>&nbsp;</td><td width="35%" 
                            style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';"></td><td width="45%"></td></tr>
             <tr><td>&nbsp;</td><td width="35%" 
                     style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';">Upload Photo</td><td width="45%"><asp:FileUpload ID="FileUpload1" 
                     ...
                     <tr><td>&nbsp;</td><td width="35%" 
                             style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';"></td><td width="45%"></td></tr>
            <tr><td>&nbsp;</td><td width="35%" 
                    style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';">Vocals</td><td width="45%"><asp:DropDownList ID="DropDownList1" 
                    runat="server" BackColor="#3366FF" Height="30px" Width="250px" 
                        ForeColor="White">
            ...
            <tr><td>&nbsp;</td><td width="35%" 
                    style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';">
                Instruments</td><td width="45%">
                    <asp:DropDownList ID="DropDownList3" 
                    runat="server" BackColor="#3366FF" Height="30px" Width="250px" 
                        ForeColor="White">
                <asp:ListItem>Tabla</asp:ListItem>
                <asp:ListItem>Violin</asp:ListItem>
                <asp:ListItem>Guitar</asp:ListItem>
                <asp:ListItem>Dholak</asp:ListItem>
                <asp:ListItem>Harmonium</asp:ListItem>
                </asp:DropDownList></td></tr>
            ...
            <tr><td>&nbsp;</td><td width="35%" 
                ...
                <asp:ListItem>Folk</asp:ListItem>
                               ...
                               <tr><td>&nbsp;</td><td width="35%" 
                                       style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';"></td><td width="45%"></td></tr>
            <tr><td>&nbsp;</td><td width="35%" 
                    style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';">School Attending</td><td width="45%">
                <asp:TextBox ID="TextBox13" runat="server" 
                    BackColor="#0066FF" Width="250px" Height="30px" ForeColor="White"></asp:TextBox></td></tr>
                               ...
                               <tr><td>&nbsp;</td><td width="35%" 
                                       style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';"></td><td width="45%"></td></tr>
            <tr><td>&nbsp;</td><td width="35%" 
                    style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';">Present Education Institute</td><td width="45%">
            ...
            <tr><td>&nbsp;</td><td width="35%" 
                    style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';">
                From where did you get to know about our Institute?</td><td width="45%">
            ...
            <tr><td>&nbsp;</td><td width="35%" 
                    style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';">
                Size of T-shirt :</td><td width="45%">
            ...
            <tr><td>&nbsp;</td><td width="35%" 
                    style="color: #000099; font-size: medium; font-weight: bold; font-family: 'Bookman Old Style';">
                Type of T-shirt :</td><td width="45%">
                    <asp:DropDownList ID="DropDownList7" 
                    runat="server" BackColor="#3366FF" Height="30px" Width="250px" 
                        ForeColor="White">
                <asp:ListItem>Full Sleev</asp:ListItem>
                <asp:ListItem>Half Sleev</asp:ListItem>
        ...
        <asp:TextBox ID="TextBox9" runat="server" />
         ...
         <a class="error-page-go-back-btn" href="abhijatsession.aspx">More Details here</a>
        <div class="clr"></div>
  ...
  <div class="modal-content">
    ...
    <h1 style="font-weight: bold; font-size: large; color: #003300; font-family: 'Courier New', Courier, monospace"</h1>
    TERMS & CONDITIONS
                                               
 	
 <br/>
  <br/> <br/> 
<p style="color: #000080; font-size: small">I ...........................declare that all the information given by me in this form
is correct. If any information is found to be wrong then the institution can take any
legal step against me.
