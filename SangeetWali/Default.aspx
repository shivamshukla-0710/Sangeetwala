...
<li><a href="registration.aspx" style="color: #FF0000; font-weight: bold">Registration Here<i class="lh-10 tc-2 fz-18 fa fa-user"></i></a>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1300px;height:500px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1300px;height:500px;overflow:hidden;">
            <div>
                <img data-u="image" src="img/red1.jpg" />
            </div>
           <div>
                <img data-u="image" src="img/blue1.jpg" />
            </div>
            <div>
        ...
        <!-- Arrow Navigator -->
        <div data-u="arrowleft" class="jssora051" style="width:30px;height:30px;top:0px;left:25px;" data-autocenter="2" data-scale="0.75" data-scale-left="0.75">
            <svg viewbox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
                <polyline class="a" points="11040,1920 4960,8000 11040,14080 "></polyline>
            </svg>
        </div>
        <div data-u="arrowright" class="jssora051" style="width:30px;height:30px;top:0px;right:25px;" data-autocenter="2" data-scale="0.75" data-scale-right="0.75">
            <svg viewbox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
    ...
    <marquee behavior="scroll" direction="left"; scrollamount="4"; onmouseover="this.stop();" onmouseout="this.start();"><asp:Label ID="LblNews" runat="server" Text="News"></asp:Label></marquee>
        ...
        <section class="container-fluid welcome sp-lg">
            <div class="container epd-x">
                ...
                <p class="section-heading-center-detail">Dr. Surendra Shankar Awasthi was founder of this orgnization .
                <br/><br/> 26 सितम्बर 1929 में उन्नाव जिले के सुमेरपुर गांव में जन्मे , भारतीय शास्त्रीय संगीत के इस महान उपासक को किसी परिचय की आवश्यकता नही है ।<br/><br/> शास्त्रीय संगीत को समर्पित इनका समस्त जीवनकाल अपने आप में उपलब्धियों का एक सागर है | 
              
संगीत की प्रारम्भिक शिक्षा बहरे वहीद खां साहब से प्राप्त करने के बाद ,  <br/>  <br/> डॉ अवस्थी 1954 में उस्ताद अमीर खां साहब के विधिवत गंडाबंध शिष्य हो गए । किराना घराने के गायको में डॉ. अवस्थी का अपना विशिष्ट स्थान है | </p>
                ...
                <div class="welcome-right col-sm-5 pd-x-l-35">
                    <div class="welcome-right-content">
                        <div class="welcome-right-content-text pd-y-b-60">
                            ...
                            <p class="fw-n ff-abee fz-15 tc-4"> In our institute , we are provided online registration for  all student through simple  ways... </p>
                        ...
                        <div class="welcome-right-content-text">
                            <h3 class="section-sub-heading-left-2">Support</h3>
                            <p class="fw-n ff-abee fz-15 tc-4">Through this website we are supported to you online ... </p>
                            <div class="welcome-right-content-text-absolute">
        ...
        <section class="our-promises xs-res sp-lg container epd-x">
           ...
           <br/><br/> About us – The institute is established in the year 2002 with the blessing of renound vocalist late Dr. Surendra Shankar Awasthi Ex. Principle Bhatkhande Hindustani <br/><br/>Sangeet Mahavidyalya Lucknow. 
            ...
            <div class="our-promises-content-wrapper pos-r">
                ...
                <div class="col-sm-4 epd-x-l pd-x-r-70">
                    <div class="our-promises-content pd-y-b-50">
                        <h3 class="section-sub-heading-left-2"><i class="flaticon-lifeline-in-a-heart-outline tc-1 pd-x-r-15"></i>WESTERN VOCAL</h3>
                    ...
                    <div class="our-promises-content pd-y-b-50">
                        <h3 class="section-sub-heading-left-2"><i class="flaticon-gavel tc-1 pd-x-r-15"></i>Bharatanatyam</h3>
                        <p class="ff-abee fz-15 fw-n tc-4 lh-26">Bharatanatyam, also spelt Bharathanatyam, is a classical dance form of South India, said to be originated in Thanjavoor of Tamil Nadu. Bharatanatyam It was known as "Daasiyattam" since performed by Devadasies in temples of Tamil Nadu long ago. The name 'Bharatanatyam' is derived from three basic concepts of Bhava, Raga and Thaala. </p>
                    </div>
                    <div class="our-promises-content">
                        <h3 class="section-sub-heading-left-2"><i class="fa fa-shield tc-1 lh-15 pd-x-r-15"></i>Folk Dance</h3>
                        <p class="ff-abee fz-15 fw-n tc-4 lh-26">There is really no such genre as folk dancing. Rather, there is a large body of unrelated non-classical dance forms. The only thing common among these dance forms is their rural origins. Many folk dances are performed by ordinary people rather than professional dancers. It is very usual that on special occasions, the villagers will gather and sing and dance, accompanying themselves on a variety of folk instruments. Such special occasions include harvesting, planting, marriages and religious holidays. </p>
                    </div>
                </div>
                ...
                <div class="col-sm-4 col-sm-offset-4 epd-x-r pd-x-l-70">
                    <div class="our-promises-content pd-y-b-50">
                        <h3 class="section-sub-heading-left-3 fr">LIGHT CLASSICAL VOCALS<i class="fa fa-home lh-15 tc-1 pd-x-l-15"></i></h3>
                        <div class="clr"></div>
                        <p class="ff-abee text-right fz-15 fw-n tc-4 lh-26">Devotional or religious music like "Kirtans" and "Bhajans", "Qawwalis", "Ghazals" ... all form a part of light, classical music genre. Most of the melodious Bollywood songs are also a part of Light Classical. which has quite often been referred to as the "commercial form of singing". This form of art is also well rehearsed and taught to students and aspiring singers. </p>
                    </div>
                    <div class="our-promises-content pd-y-b-50">
                        <h3 class="section-sub-heading-left-3 fr"> Kathak Dance <i class="fa fa-medkit lh-15 tc-1 pd-x-l-15"></i></h3>
                        <div class="clr"></div>
                    ...
                    <div class="our-promises-content">
                        <h3 class="section-sub-heading-left-3 fr"> Instruments <i class="fa fa-book lh-15 tc-1 pd-x-l-15"></i></h3>
                        <div class="clr"></div>
