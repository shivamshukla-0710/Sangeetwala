<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hair_transplant.aspx.cs" Inherits="Admin_Hair_transplant" %>
...
<a href="../Default.aspx"><img src="../images/logo.png" height="60px" width="240px" style="margin-left:10px; margin-top:-50px"  title="Dr Agarwals EYE HOSPITAL"></a></h1>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right custom-menu" style="margin-right:0px;">
            ...
            <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" title="Speciality Care"><strong>BRANCHES</strong><span class="caret"></span></a>
             <!-- <ul class="dropdown-menu">
        ...
        <div class="branch_main agarwal-wrapper">
		  <div class="container">
          <h1 class="gl_head1">STUDENT VIDEO SECTION</h1>
           
           <A href="../Stu_Sect.aspx"><img src="../images/Kampanj2014.png" style="width: 25px; height: 25px">Back for other section</a>
		 <div>
              &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; 
