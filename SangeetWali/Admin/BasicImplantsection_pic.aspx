<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.master" AutoEventWireup="true" CodeFile="BasicImplantsection_pic.aspx.cs" Inherits="Admin_BasicImplantsection_pic" %>
...
<tr><td>Category&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td><td>
    <br />
            <asp:DropDownList ID="DropDownList1" runat="server">
                <asp:ListItem>basic_implants</asp:ListItem>
                <asp:ListItem>advance_implants</asp:ListItem>
            </asp:DropDownList>
        <br />
    <br />
