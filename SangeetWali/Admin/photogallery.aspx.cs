...
public partial class Admin_photogallery : System.Web.UI.Page
{
    ...
    private DataView Getdata()
    {
        ...
        string strSelectCmd = "SELECT * from gallery";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            con.Close();
            SqlCommand cmd = new SqlCommand("delete from gallery where id = '" + e.CommandArgument.ToString().Trim() + "'", con);
            cmd.Connection.Open();
            cmd.ExecuteNonQuery();
            con.Close();
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sqlstring = "INSERT INTO gallery  (Title,Image) values (@Title,@Image)";
