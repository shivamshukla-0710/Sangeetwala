...
public partial class Admin_BasicImplantsection_pic : System.Web.UI.Page
{
    ...
    private DataView Getdata()
    {
        ...
        string strSelectCmd = "SELECT * from gallery2";
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        {
            con.Close();
            SqlCommand cmd = new SqlCommand("delete from gallery2 where id = '" + e.CommandArgument.ToString().Trim() + "'", con);
            cmd.Connection.Open();
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Redirect("BasicImplantsection_pic.aspx");
        }
    }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string sqlstring = "INSERT INTO gallery2  (Title,Image,categ) values (@Title,@Image,@categ)";
