<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VID_flap.aspx.cs" Inherits="Admin_VID_flap" %>
...
<a href="../Default.aspx"><img src="../images/logo.png" height="90px" width="130px" style="margin-left:10px; margin-top:-50px"  title="SANJEEVANI EDUCATION"></a></h1>
        ...
        <div class="branch_main agarwal-wrapper">
		  <div class="container">
          <h1 class="gl_head1">FLAP RECONSTRUCTION VIDEO SECTION</h1>
           
           <A href="../Flap_Super.aspx"><img src="../images/Kampanj2014.png" style="width: 25px; height: 25px">Back for other section</a>
		 <div>
              &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; 
