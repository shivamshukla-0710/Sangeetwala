...
<li><a href="registration.aspx" style="color: #FF0000; font-weight: bold">Registration Here<i class="lh-10 tc-2 fz-18 fa fa-user"></i></a>
        ...
        <div class="other-page-header clearfix container-fluid epd-x">
            <h1 class="ff-ssp fz-40 fw-b text-center tc-6 lh-26 pd-y-b-60 text-uppercase">News Update </h1>
            <h4 class="ff-ssp text-center tc-6 fz-14 lh-10 fw-b text-uppercase"><a href="Default2.aspx" class="tc-6">home</a><i class="fa fa-chevron-right pd-x-10 fz-10"></i><span class="tc-2 lh-10">404</span></h4>
        </div>
        <div class="clr"></div>
        <!-- page heading end -->
        ...
        <section class="error-page container epd-x sp-lg">
             ...
             <h3 class="txtOrng"><asp:Label ID="LabHad" runat="server"></asp:Label></h3>
            
            <div class="error-page-img-holder">
                 
               
                  <br/>
        <asp:Image ID="Image1" runat="server" CssClass ="underHeading" 
            Visible="False" ImageAlign="Middle" Width="50%" />
   <br/>  <br/>
    
            </div>
          <asp:Label ID="lblPara1" runat="server" CssClass="content" Font-Bold="True" Font-Size="16px"></asp:Label>
        </section>
        <div class="clr"></div>
