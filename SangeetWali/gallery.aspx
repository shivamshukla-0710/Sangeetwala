...
<li><a href="registration.aspx" style="color: #FF0000; font-weight: bold">Registration Here<i class="lh-10 tc-2 fz-18 fa fa-user"></i></a>
        ...
        <div class="other-page-header clearfix container-fluid epd-x">
            <h1 class="ff-ssp fz-40 fw-b text-center tc-6 lh-26 pd-y-b-60 text-uppercase">portfolio</h1>
            <h4 class="ff-ssp text-center tc-6 fz-14 lh-10 fw-b text-uppercase"><a href="Default2.aspx" class="tc-6">home</a><i class="fa fa-chevron-right pd-x-10 fz-10"></i><span class="tc-2 lh-10">portfolio</span></h4>
        </div>
        <div class="clr"></div>
        <!-- page heading end -->
        ...
        <section class="portfolio-page container sp-lg-9 epd-x">
            <div class="portfolio-page-content-wrapper clearfix pd-y-b-85">
                ...
                <div class="col-md-4 epd-x">
                    <div class="epd-x m-x-r-20 pd-y-b-15 pd-y-t-15 portfolio-page-content col-md-12">
                ...
                <div class="col-md-4 epd-x">
                    <div class="m-x-r-10 epd-x m-x-l-10 pd-y-b-15 pd-y-t-15 portfolio-page-content col-md-12">
                ...
                <div class="col-md-4 epd-x">
                    <div class="epd-x m-x-l-20 pd-y-b-15 pd-y-t-15 portfolio-page-content col-md-12">
            ...
            <div class="clr"></div>
             ...
             <asp:DataList ID="DataList1" runat="server" RepeatColumns="3" 
                    ...
                    <ItemTemplate>
                        <div class="gallery">
                            <asp:Label ID="Label1" runat="server" Style="padding-bottom: 10px" 
                                Text='<%# Eval("title") %>' Font-Bold="True" ForeColor="#990000"></asp:Label>
                            <br />
                            <a id="A1" runat="server" class="fancybox" data-fancybox-group="gallery" 
                                href='<%#Eval("Image") %>'>
                            <asp:Image ID="Image1" runat="server" Height="200px" 
                                ImageUrl='<%# Eval("image") %>' Width="370px" />
                            </a></a><br />
                        </div>
                    </ItemTemplate>
                </asp:DataList>
