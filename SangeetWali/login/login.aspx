      ...
      <img src="../images/logo/logo.png" />
									...
									<div class="card bg-white">
										<div class="card-content">
											...
											<form class="form-horizontal ng-pristine ng-valid">
												<fieldset>
                                                <div class="form-group" style="font-family: 'Century Schoolbook'">
														<div class="ui-input-group">
															
                                                            <asp:DropDownList ID="DropDownList1" runat="server" required class="form-control"  ForeColor="Maroon">
													...
													<div class="form-group">
														<div class="ui-input-group">
															 <asp:TextBox  ID="TextBox2" runat="server" required class="form-control" 
         ...
         <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/img/login-button (2).png" 
									...
									<div class="additional-info">
                                        ...
                                        <br/><br/><a href="sign_up.aspx">Register</a><span class="divider-h"></span><a href="#/page/forgot-password">Forgot your password?</a>
									</div>
								</div>
							</div>
						</div>
